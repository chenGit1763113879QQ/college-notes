...
总体：$X$;样本：$X_1,\cdots,X_n$;样本观测值$x_1,\cdots,x_n$
...
3. $t$ 分布 $: \quad t=\frac{X}{\sqrt{\boldsymbol{Y} / \boldsymbol{n}}} \sim \boldsymbol{t}(\boldsymbol{n}), \boldsymbol{P}\left\{t>t_{\alpha}(\boldsymbol{n})\right\}=\boldsymbol{\alpha}$
