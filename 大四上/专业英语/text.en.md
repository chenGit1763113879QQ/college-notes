...
Fig.1. Convergence curves of ADP using neural networks. 

Fig.1. Time-space diagram of the schedule under the ADP policy. 

Fig.8.Time-space diagram of the schedule under the myopic policy. 

**Table 4** Performances of different. 
 
Fig.10. Convergence curves under different rates of . 

### 5.4. The influence of $\lambda$
