...
![如图 1. 单周期 VSP 的示例 ](pics/Fig1.png)
...
![如图 5. 近似值函数的三层神经网络](pics/Fig5.png)
...
![ADP算法框架](pics/ADP_algorithmic_framework.png)
...
![图7.ADP政策下的时间表时空图](pics/Fig7.png)

![图8.近视政策下的时间表时空图](pics/Fig8.png)
