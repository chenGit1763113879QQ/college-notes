...
- 离散后加滤波器：进一步将高频分量滤除，时域上看，相当于把输出响应的阶梯展平
...
1. 离散系统稳定性差
2. 采样周期T是影响稳定性的重要参数，一般来说，T减小，稳定性增强

## 8、静态误差系数和系统性能指标的关系

9、离散系统闭环零极点和系统动态响应的关系；
...
- 稳定性(P103)🈯️当扰动作用消失以后，系统恢复原平衡状态的性能。只与系统本身特性有关

- 稳定判据(P104,4.2.1)
  - 直接求解特征方程根
  - 间接代数判据
    - 劳斯稳定判据(ppt chap4 16)$z=\frac{1+w}{1-w}$
    - 朱利代数判据 P106
- 稳态误差分析(P109,4.3)
